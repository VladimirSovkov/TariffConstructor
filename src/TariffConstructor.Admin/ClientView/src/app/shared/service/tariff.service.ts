...
export class TariffService{
  ...
  serach: SearchResult<SimplifiedTariff>;
  constructor(private http: HttpClient) {}

  getData(searchPattern: TariffSearchPattern): Observable<SearchResult<SimplifiedTariff>>{
    ...
    return this.http.get<SearchResult<SimplifiedTariff>>('http://localhost:4401/test/search', {params});
  }
}

...
namespace TariffConstructor.Infrastructure.Data
{
    public static class HiLoSequence
    {
        ...
        public static readonly string DBSequenceHiLoForSettingsSet = "DBSequenceHiLoFor";

        // TariffAggragate
        public static readonly string DBSequenceHiLoForAvailableProductOptionTariffInTariff = "DBSequenceHiLoForAvailableProductOptionTariffInTariff";
        public static readonly string DBSequenceHiLoForAvailableTariffForUpgrade = "DBSequenceHiLoForAvailableTariffForUpgrade";
        public static readonly string DBSequenceHiLoForIncludedProductInTariff = "DBSequenceHiLoForIncludedProductInTariff";
        public static readonly string DBSequenceHiLoForIncludedProductOptionInTariff = "DBSequenceHiLoForIncludedProductOptionInTariff";
        public static readonly string DBSequenceHiLoForTariffAdvancePrice = "DBSequenceHiLoForTariffAdvancePrice";
